...
@EnableJpaRepositories(
        basePackages = "com.emie.designpm.background.repository",
...
public class BackgroundJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean backgroundEntityManagerFactory(
            EntityManagerFactoryBuilder builder, @Qualifier("backgroundDataSource") DataSource backgroundDataSource) {
