...
public class PointAppeal {
    ...
    @Column(name = "applicant_user_id", nullable = false, length = 100)
    ...
    @Column(name = "corrected_score", precision = 12, scale = 1)
    ...
    @Column(name = "planner_decision", length = 20)
    private String plannerDecision;

    @Column(name = "planner_comment", length = 1000)
    private String plannerComment;

    @Column(name = "planner_user_id", length = 100)
    private String plannerUserId;

    @Column(name = "planner_name", length = 100)
    private String plannerName;

    @Column(name = "planner_processed_at")
    private LocalDateTime plannerProcessedAt;
    ...
    public boolean isOverdue() {
        return !List.of("APPROVED", "REJECTED").contains(status)
                && dueAt != null
