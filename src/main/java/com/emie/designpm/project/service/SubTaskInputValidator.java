...
public class SubTaskInputValidator {
    ...
    public SubTaskInputValidator(UserService userService,
    ...
    String collaboratorAllocations(Object raw, String primaryUserId) {
        return subTaskInputPolicy == null ? validateCollaboratorAllocations(raw, primaryUserId) : subTaskInputPolicy.collaboratorAllocations(raw, primaryUserId);
    }
