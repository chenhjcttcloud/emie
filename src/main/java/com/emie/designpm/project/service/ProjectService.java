...
public class ProjectService {
    ...
    public ProjectService(ProjectRepository projectRepository,
        ...
        this.projectScoringService = projectScoringService;
    }
    ...
    public long countPendingScoresForUser(String role, String userId) {
        return projectScoringService.countPendingScoresForUser(role, userId);
    }
    ...
    public double currentScoringWeight(String projectType, String role) {
        return projectScoringService.currentScoringWeight(projectType, role);
    }
    ...
    public boolean isTaskFullyCompleted(SubTask task) {
        return projectScoringService.isTaskFullyCompleted(task);
    }
    ...
    public Double computeProjectScore(Project project) {
        return projectScoringService.computeProjectScore(project);
    }
