...
public class NotificationRecipientRouter {
    ...
    public NotificationRecipientRouter(
            Environment environment, @Value("${app.notification.test-recipient-user-id:}") String testRecipientUserId) {
    ...
    public List<String> routeAll(Collection<String> intendedRecipientUserIds) {
        ...
        return intendedRecipientUserIds == null
                ? List.of()
                : intendedRecipientUserIds.stream()
