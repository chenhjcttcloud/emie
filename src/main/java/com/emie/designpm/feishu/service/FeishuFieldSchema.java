...
final class FeishuFieldSchema {
    ...
    static Map<String, Map<String, Integer>> catalog() {
        ...
        result.put(
                "project",
                fields(
                        "项目ID", "项目编号", "项目名称", "产品名称", "类型", "状态", "销售", "产品企划", "截止日期", "产品类目", "参考价格", "子任务数",
                        "完成进度", "项目流程", "子任务流程", "当前审核阶段", "审核进度", "创建时间", "项目描述", "同步来源", "目标市场", "合规项", "IP名称",
                        "创意作者", "来源", "产品类目备注", "需求说明"));
        result.put(
                "task",
                fields(
                        "子任务ID", "任务名称", "状态", "负责人", "计划日期", "实际完成日期", "自评分", "所属项目", "一审角色", "一审状态", "一审得分", "一审审核人",
                        "二审角色", "二审状态", "二审得分", "二审审核人", "审核得分", "创建时间", "所属阶段", "负责人类型", "发布人", "细节要求说明", "交付成果",
                        "审核意见", "同步来源"));
        result.put(
                "scoring",
                fields("评分ID", "评分角色", "评分", "权重", "项目ID", "项目类型", "审核阶段", "审核状态", "审核人", "审核意见", "同步来源", "所属子任务"));
