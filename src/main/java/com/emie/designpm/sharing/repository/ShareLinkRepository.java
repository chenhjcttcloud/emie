package com.emie.designpm.sharing.repository;
...
public interface ShareLinkRepository extends JpaRepository<ShareLink, Long> {
    ...
    @Modifying
    @Query(
            "update ShareLink s set s.viewCount = s.viewCount + 1 where s.id = :id and (s.maxViews = 0 or s.viewCount < s.maxViews) and s.status = 'active'")
