...
public class PointManualAdjustmentService {
    ...
    public PointManualAdjustmentService(PointAdjustmentLedgerRepository a, UserRepository u) {
        adjustments = a;
        users = u;
    }

    @Transactional
    public PointAdjustmentLedger adjust(String userId, Integer points, String reason, AuthSession s) {
        requireRole(s);
    ...
    private void requireRole(AuthSession s) {
