...
@Service public class PointManualAdjustmentService {
 ...
 @Transactional public PointAdjustmentLedger adjust(String userId,Integer points,String reason,AuthSession s){
 ...
 private void requireRole(AuthSession s){if(!"admin".equals(PermissionCatalog.normalizeRole(s.role())))throw new SecurityException("仅管理员可操作");}
