  ...
  modal.innerHTML = `
    <div class="modal" style="max-width:520px;">
      ...
      <div class="modal-body">
        <div id="shareForm">
          ...
          <div id="shareCreateArea">
            <button class="btn btn-primary btn-lg" data-emie-action="click:share-create" data-project-id="${projectId}" style="width:100%;justify-content:center;">生成分享链接</button>
          </div>
          <div id="shareResultArea" style="display:none;">
            <div class="form-group">
              ...
              <div style="display:flex;gap:8px;">
                ...
                <button class="btn btn-primary" data-emie-action="click:share-copy">复制</button>
              </div>
            </div>
      ...
      <div class="modal-footer" style="justify-content:center;">
        <button class="btn btn-outline" data-emie-action="click:share-close">关闭</button>
      </div>
    </div>`;
...
if (registerEventAction) {
  registerEventAction('share-create', (_event, element) =>
    doCreateShareLink('project', Number(element.dataset.projectId)));
  registerEventAction('share-copy', () => copyShareUrl());
  registerEventAction('share-close', () => closeM('shareModal'));
}
