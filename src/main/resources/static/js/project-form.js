      ...
      <div class="modal-body">
        ...
        <div style="margin-top:20px;padding-top:16px;border-top:1px solid var(--gray-200);">
          ...
          <div class="upload-area" data-emie-onclick="document.getElementById('createRefImageInput').click()">
            ...
            <input type="file" id="createRefImageInput" multiple accept="${EMIE.fileAccept.reference}" style="display:none" data-emie-onchange="handleCreateRefImages(this)">
          </div>
        ...
        <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--gray-200);">
          ...
          <div class="upload-area" data-emie-onclick="document.getElementById('createAttachmentInput').click()">
            ...
            <input type="file" id="createAttachmentInput" multiple accept="${EMIE.fileAccept.attachment}" style="display:none" data-emie-onchange="handleCreateAttachments(this)">
          </div>
