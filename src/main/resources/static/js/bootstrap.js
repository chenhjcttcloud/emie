...
import './core-auth.js?v=148';
import './core-identity.js?v=148';
import './core-shell.js?v=172';
import './core-ui.js?v=147';
import './core.js?v=147';
import './dashboard-projects.js?v=157';
import './dashboard-home.js?v=160';
import './dashboard-lists.js?v=179';
import './dashboard-scoring.js?v=160';
import './dashboard-designer.js?v=174';
import './dashboard.js?v=147';
import './project-uploads.js?v=148';
import './project-form.js?v=180';
import './project-detail.js?v=181';
import './project-tasks.js?v=180';
import './project-sharing.js?v=147';
import './projects.js?v=148';
import './admin-shell.js?v=150';
import './admin-users.js?v=166';
import './admin-roles.js?v=148';
