...
import './core-ui.js?v=316';
import './core.js?v=147';
import './dashboard-projects.js?v=254';
import './dashboard-home.js?v=227';
import './dashboard-lists.js?v=278';
import './dashboard-scoring.js?v=196';
import './dashboard-points.js?v=70';
import './dashboard-designer.js?v=327';
import './dashboard.js?v=219';
import './project-uploads.js?v=283';
import './project-form.js?v=313';
import './project-detail.js?v=354';
import './project-tasks.js?v=377';
...
import './admin-scoring.js?v=302';
import './admin-audit.js?v=291';
