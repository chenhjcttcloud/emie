import './core-runtime.js?v=293';
import './event-runtime.js?v=269';
import './core-auth.js?v=398';
import './core-identity.js?v=496';
import './core-shell.js?v=481';
import './core-ui.js?v=493';
import './core.js?v=147';
import './dashboard-projects.js?v=441';
import './dashboard-home.js?v=583';
import './dashboard-lists.js?v=409';
import './dashboard-scoring.js?v=342';
import './dashboard-points.js?v=357';
import './dashboard-designer.js?v=557';
import './dashboard.js?v=219';
import './material-market.js?v=124';
import './image-library.js?v=74';
import './project-uploads.js?v=480';
import './project-form.js?v=417';
import './project-detail.js?v=594';
import './project-tasks.js?v=644';
import './project-sharing.js?v=264';
import './projects.js?v=148';
import './admin-shell.js?v=391';
import './admin-users.js?v=275';
...
import './admin-workload.js?v=455';
